...
public class PhotoView extends GLView {
    ...
    private static int MOVE_THRESHOLD = 256;
	...
	private float mDensity = 1;   //add for MOVE_THRESHOLD fitting various screen density by fuqiang

    public PhotoView(GalleryActivity activity) {
        mTileView = new TileImageView(activity);
        addComponent(mTileView);
        Context context = activity.getAndroidContext();
		mDensity = context.getResources().getDisplayMetrics().density;   //add for MOVE_THRESHOLD fitting various screen density by fuqiang
		MOVE_THRESHOLD = (int)(MOVE_THRESHOLD * mDensity);
