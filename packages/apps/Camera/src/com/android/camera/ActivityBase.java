...
abstract public class ActivityBase extends AbstractGalleryActivity
	...
	protected void startFaceDetectionInCamera(){   //for facedetection open and close by fuqiang
	}
    ...
    class MyAppBridge extends AppBridge implements CameraScreenNail.Listener {
		...
		@Override
		public void startFaceDetectionInCamera(){   //for facedetection open and close ny fuqiang
			ActivityBase.this.startFaceDetectionInCamera();
		}

		@Override
		public void stopFaceDetectionInGallery(){
			ActivityBase.this.stopFaceDetectionInGallery();
		}
