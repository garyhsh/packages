...
public class VideoCamera extends ActivityBase
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (Intent.ACTION_BATTERY_CHANGED.equals(action)) {
				...
				if(Level < 6)
				{
					...
					Runnable runnable_close_videocamera = new Runnable() {
			            @Override
			            public void run() {
							//close the videocamera.
					...
					mRotateDialog.showAlertDialog(
		                ...
		                null, null,
		                getString(R.string.close), runnable_close_videocamera);
				}
			}
		}
	};
    ...
    protected void onResume() {
		...
		//install an intent filter to receive battery change
